...
## Tile-Lifecycle (Stand 04.02.2026)

GDB-Dateien (~50-500MB pro Tile) werden für Speicheroptimierung nach dem Import gelöscht.
Alle Layer (Building, Roof, Wall) werden beim Prefetch importiert - kein On-Demand Reload nötig.
...
├─────────────────────────────────────────────────────────────────┤
│                                                                 │
│  Prefetch (automatisch, alle Layer)                            │
│  ══════════════════════════════════                             │
...
│                                                                 │
│  KEIN On-Demand Reload mehr nötig!                             │
│  Alle Daten sind nach dem Prefetch in der DB.                  │
│                                                                 │
...
| `get_tile_path()` | tile_cache.py | Gibt GDB-Pfad zurück (oder None) |
