#!/usr/bin/env python3
"""Write the new ProjectsPage.tsx content."""
...
if __name__ == '__main__':
    path = 'C:/Users/vonro/projects/lawil/geodaten-ch/geruestbau-app/src/pages/ProjectsPage.tsx'
    with open(path, 'w', encoding='utf-8') as f:
        f.write(content)
    print(f'Written {len(content)} bytes to ProjectsPage.tsx')
