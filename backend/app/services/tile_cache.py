...
class TileCacheService:
    ...
    # FIX 04.02.2026: get_or_redownload_tile_for_coordinates() ENTFERNT
    # Walls werden immer beim Prefetch importiert (IMPORT_ALL_LAYERS entfernt).
    # Kein Reload von GDB-Dateien mehr nötig - alle Daten sind in der DB.
...
# FIX 04.02.2026: get_or_redownload_gdb_path_for_tile() ENTFERNT
# Walls werden immer beim Prefetch importiert. Kein Reload nötig.
