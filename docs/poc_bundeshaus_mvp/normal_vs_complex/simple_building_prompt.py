...
def generate_simple_elevation_prompt(
    ...
    if zones and len(zones) > 0:
        zone = zones[0]
        hoehe = zone.get('gebaeudehoehe_m') or zone.get('firsthoehe_m') or zone.get('traufhoehe_m') or 10
        traufhoehe = zone.get('traufhoehe_m') or hoehe * 0.7
    else:
    ...
    breite = building_data.get('fassadenbreite_m') or building_data.get('facade_length_m') or 12
    geschosse = building_data.get('geschosse') or building_data.get('gastw') or 3
...
def generate_simple_cross_section_prompt(
    ...
    if zones and len(zones) > 0:
        zone = zones[0]
        hoehe = zone.get('gebaeudehoehe_m') or zone.get('firsthoehe_m') or 10
        traufhoehe = zone.get('traufhoehe_m') or hoehe * 0.7
    else:
        hoehe = building_data.get('hoehe_m') or building_data.get('gebaeudehoehe_m') or 10
        traufhoehe = building_data.get('traufhoehe_m') or hoehe * 0.7
    ...
    # Tiefe und Geschosse
    tiefe = building_data.get('gebaeudetiefe_m') or 10
    geschosse = building_data.get('geschosse') or building_data.get('gastw') or 3
