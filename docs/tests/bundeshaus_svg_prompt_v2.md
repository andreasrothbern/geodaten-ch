...
- **Dachform:** kuppel
- **Dachneigung:** 15°
- **First-Ausrichtung:** RoofOrientation.NORTH_SOUTH
- **Dachflaeche:** 120 m2
- **Konfidenz:** 100%
...
> Das Gebäude hat eine U-Form mit offener Seite nach Süden. Der Ehrenhof (Innenhof) ist NICHT zu überdachen und bleibt frei.
...
|--------|---------|----------|-------|
| Z1 | N | 93% | Automatisch verteilt (44.3m Abstand) → Ecke (Ende) |
| Z2 | N | 7% | Automatisch verteilt (44.3m Abstand) → Ecke (Start) |
| Z3 | O | 42% | Automatisch verteilt (44.3m Abstand) |
| Z4 | O | 3% | Automatisch verteilt (44.3m Abstand) → Ecke (Start) |
| Z5 | S | 47% | Automatisch verteilt (44.3m Abstand) |
| Z6 | W | 51% | Automatisch verteilt (44.3m Abstand) |
| Z7 | N | 93% | Automatisch verteilt (44.3m Abstand) → Ecke (Ende) |
...
> **[!] WICHTIG:** U-Form zeichnen! Ehrenhof in der Mitte als Freifläche markieren (NICHT schraffieren).
...
> **[!] WICHTIG:** Kuppel zentral, Arkaden im Erdgeschoss, 3 verschiedene Höhenzonen beachten.
...
> **[!] WICHTIG:** Zeige alle 3 Höhenzonen: Arkaden 6m, Hauptgebäude 25m, Kuppel bis 64m.
